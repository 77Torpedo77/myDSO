...
PangolinDSOViewer::PangolinDSOViewer(class pclSetting* &pclSetting_arg,int w, int h, bool startRunThread )
{
    ...
    std::cout<<thread_id_str+"//////////////////pango_init///////////////////"<<std::endl;
    std::cout<<_pclSetting->strTmpFileName+"//////////////////pango_tmp_name///////////////////"<<std::endl;
...
void PangolinDSOViewer::run()
{
    ...
    pangolin::Var<bool> settings_savePCButton("ui.save-"+thread_id_str,false,false);
