...
// Added By Yo Han.
//extern thread_local bool isSavePCL;
//extern thread_local bool isPCLfileClose;
//extern thread_local int numPCL;
//extern thread_local std::string strTmpFileName;
//extern thread_local std::string strSaveFileName;
//extern thread_local bool isWritePCL;
